...
def run_transmiter(n,nbytes,tb,norestart,pkt_size,position):    
	if (norestart.value==1):
	      ...
	      source_file = open("/home/kranthi/documents/sound_cognition/txfifo.ts",'r') # Source file location	# Added Line
	      source_file.seek(position.value,0)
	      file_size = os.path.getsize("/home/kranthi/documents/sound_cognition/txfifo.ts")
	      print file_size
